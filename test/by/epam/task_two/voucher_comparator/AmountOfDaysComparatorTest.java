...
public class AmountOfDaysComparatorTest {
    ...
    @Test
    public void testCompareAmountOfDaysComparator() {
        Comparator<Voucher> amountOFDays = new AmountOfDaysComparator();
        vouchersToTest.sort(amountOFDays);
